...
/**
Create Excel File Deliverables List
...
$logoGenmabUrl = 'https://genmab.dev.cloud.processmaker.net/public-files/GENMAB%20IMAGES/GenmabDocs.png';
...
//Insert the image in the sheet position M1
$contentLogo = file_get_contents($logoGenmabUrl);
$logoGenmabPath = '/tmp/logogenmab.png';
file_put_contents($logoGenmabPath, $contentLogo);
$logoGenmab = new PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
$logoGenmab->setPath($logoGenmabPath);
...
$newFile = $apiInstance->createRequestFile($processRequestId, $dataName, $outFile);
$fileUID = $newFile->getFileUploadId();

$aReturn['DELIVERABLES_LIST_LINK'] = $_SERVER["HOST_URL"] . '/request/' . $processRequestId . '/files/' . $fileUID;
return $aReturn;
